...
try:
    ...
    driver.find_element_by_name('Name').send_keys('Samuel')
    time.sleep(3)
    print("Typing your Email address...")
    driver.find_element_by_name('Email').send_keys('Samuel2002@gmail.com')
    time.sleep(3)
    select =Select(driver.find_element_by_class_name('form-control'))
    time.sleep(3)
    select.select_by_visible_text('UG Student')
    time.sleep(3)
